...
def main():
    ...
    while run:
        ...
        if hit:
            ...
            button_exit = pygame.Rect(WIDTH/2 +150, HEIGHT/2 + lost_text.get_height() +
            ...
            WINDOW.blit(exit_button_text,(WIDTH/2 + 75, HEIGHT/2 + lost_text.get_height() + play_again_text.get_height() + 10))
